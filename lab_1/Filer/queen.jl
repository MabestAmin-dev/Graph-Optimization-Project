...
@constraint(BOARD, con3[k in 0:6], 
    sum(x[i + k, i] for i in 1:(8 - k)) <= 1)
# 
@constraint(BOARD, con4[k in 1:6], 
    sum(x[i, i + k] for i in 1:(8 - k)) <= 1)
# 
@constraint(BOARD, con5[k in 1:6], 
    sum(x[i, 9 - i - k] for i in 1:(8 - k)) <= 1)
# 
@constraint(BOARD, con6[k in 0:6], 
    sum(x[i + k, 9 - i] for i in 1:(8 - k)) <= 1)
